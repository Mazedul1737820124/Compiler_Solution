...
static yyconst short int yy_base[17] =
    {   0,
        0,    0,   16,   17,    0,    4,    0,    0,    6,    0,
        8,   10,    0,   17,   13,   12
    } ;

static yyconst short int yy_def[17] =
    {   0,
       14,    1,   14,   14,   15,   15,   16,   15,   15,   16,
       15,   15,   12,    0,   14,   14
    } ;

static yyconst short int yy_nxt[23] =
    {   0,
        4,    5,    6,    5,    7,    9,    9,   11,   11,   12,
       12,   13,   13,   10,    8,   14,    3,   14,   14,   14,
       14,   14
    } ;

static yyconst short int yy_chk[23] =
    {   0,
        1,    1,    1,    1,    1,    6,    6,    9,    9,   11,
       11,   12,   12,   16,   15,    3,   14,   14,   14,   14,
       14,   14
    } ;
